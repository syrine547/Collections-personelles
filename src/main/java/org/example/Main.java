...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(DashboardController.class.getResource("/GestionCartePostale.fxml"));
            javafx.scene.Parent root = loader.load();
            System.out.println("Fichier FXML chargé avec succès !");
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("Erreur lors du chargement de GestionCartePostale.fxml");
        }
    }
}